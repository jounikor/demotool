...
const struct addr_plugin plugin_info = {
	{
	ADDR_PLUGIN_ID,
	ADDR_PLUGIN_MAJOR,
	ADDR_PLUGIN_MINOR,
	ADDR_RESERVED,
	"$VER: addr_plugin "MSTR(ADDR_PLUGIN_MAJOR)"."MSTR(ADDR_PLUGIN_MINOR)" (2.8.2023) by Jouni 'Mr.Spiv' Korhonen",
	"Over the network Absolute address program launcher",
